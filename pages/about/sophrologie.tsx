    ...
    <div>
      ...
      <main className="px-5 max-w-3xl m-auto">
        ...
        <p className="text-justify my-3 indent-6">
          ...
          techniques occidentales comme orientales. Le terme SOPHROLOGIE,
          inspiré du grec ancien*, signifie étude de l’harmonisation de la
          conscience.
        </p>
        <p className="text-justify my-3 indent-6">
          Méthode exclusivement verbale et non tactile, la sophrologie emploie
          un ensemble de techniques qui vont à la fois agir sur le corps et sur
          le mental. Elle combine des exercices qui travaillent à la fois sur la
          respiration, la décontraction musculaire et l’imagerie mentale (ou
          visualisation). Toutes ces techniques permettent de retrouver un état
          de bien-être et d’activer tout son potentiel. La sophrologie permet
          d’acquérir une meilleure connaissance de soi et d’affronter les défis
          du quotidien avec sérénité.
        </p>
        <p className="text-justify my-3 indent-6">
          ...
          comme la méditation, le yoga et le zen. Il a fait de cette technique
        ...
        <p className="text-justify my-3 indent-6">
          ...
          précise. Il a défini des exercices de relaxation dynamique qui sont
          des mouvements doux associés à la respiration et a mis au point des
